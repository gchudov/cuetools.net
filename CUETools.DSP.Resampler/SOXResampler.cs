...
namespace CUETools.DSP.Resampler
{
	...
	{
		AudioPCMConfig inputPCM;
		AudioPCMConfig outputPCM;
		rate_t[] rate;
		rate_t[] rateUp2;
		rate_shared_t shared;
		rate_shared_t sharedUp2;
