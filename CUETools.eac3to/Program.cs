...
namespace CUETools.eac3to
{
    class Program
    {
        static void Usage()
        {
            Console.Error.WriteLine("CUETools.eac3to, Copyright (C) 2018-2022 Grigory Chudov.");
...
#endif
            {
...
#endif
                {
                    ...
                    if (queryMeta)
                    {
                        ...
                        ctdb.ContactDB(null, "CUETools.eac3to 2.2.0", "", false, true, CTDBMetadataSearch.Extensive);
