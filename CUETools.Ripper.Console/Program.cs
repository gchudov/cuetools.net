...
namespace CUETools.ConsoleRipper
{
	...
	class Program
	{
		...
		static void Main(string[] args)
		{
			...
			Console.WriteLine("CUERipper v2.2.3 Copyright (C) 2008-2023 Grigory Chudov");
...
#endif
			{
				...
				ctdb.Init(arVerify);
				ctdb.ContactDB(null, "CUETools.ConsoleRipper 2.2.3", audioSource.ARName, true, false, CTDBMetadataSearch.Fast);
