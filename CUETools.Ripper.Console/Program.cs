...
namespace CUETools.ConsoleRipper
{
	...
	class Program
	{
		...
		static void Main(string[] args)
		{
			...
			Console.WriteLine("CUERipper v2.2.1 Copyright (C) 2008-2022 Grigory Chudov");
...
#endif
			{
				...
				ctdb.Init(arVerify);
				ctdb.ContactDB(null, "CUETools.ConsoleRipper 2.2.1", audioSource.ARName, true, false, CTDBMetadataSearch.Fast);
