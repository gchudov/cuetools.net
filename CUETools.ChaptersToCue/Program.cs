...
namespace CUETools.ChaptersToCue
{
	class Program
	{
        ...
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("CUETools.ChaptersToCue v2.2.0 Copyright (C) 2017-2022 Grigory Chudov");
            ...
            if (queryMeta)
            {
                ...
                ctdb.ContactDB(null, "CUETools.ChaptersToCue 2.2.0", "", false, true, CTDBMetadataSearch.Extensive);
