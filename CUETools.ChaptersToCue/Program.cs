...
// 
// ChaptersToCue
// Copyright (C) 2018-2022 Grigory Chudov (gchudov@gmail.com)
// 
...
namespace CUETools.ChaptersToCue
{
	class Program
	{
        ...
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("CUETools.ChaptersToCue v2.2.1 Copyright (C) 2017-2022 Grigory Chudov");
            ...
            if (queryMeta)
            {
                ...
                ctdb.ContactDB(null, "CUETools.ChaptersToCue 2.2.1", "", false, true, CTDBMetadataSearch.Extensive);
